                        ...
                        <div class="col-md-12">
                            <form method="GET" action="">
                                <select name="subcategoria">
                                    <?php
                                    $lista = $obj->listSubCategoria()->fetchAll();
                            ...
                            <div class="box-chart">
                                ...
                                if (!empty($_GET['subcategoria'])) {
                                    $array = $obj->grafico1($_GET['subcategoria']);
                                }
                                ?>
                                ...
                                <script type="text/javascript">
                                    ...
                                    for (var i = 0; i < count; i++) {
                                        nomes.push(info[i][0]['descricao']);
                                        dados1.push(info[i][0]['pdv']);
                                        dados2.push(info[i][0]['media']);
                                        dados3.push(info[i][0]['presenca']);
                                        dados4.push(info[i][0]['cobertura']);
                                    }
