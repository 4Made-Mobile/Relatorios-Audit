                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-chart">
                                ...
                                <script type="text/javascript">
                                    ...
                                    var data = {
                                        labels: ["Coisa 1", "Coisa 2", "Coisa 3", "Coisa 4", "Coisa 5", "Coisa 6", "Coisa 7", "Coisa 8", "Coisa 9", "Coisa 10", "Coisa 11", "Coisa 12"],
                                        datasets: [
                                            {
                                            ...
                                            {
                                                label: "Dados Quartearios",
                                                fillColor: "rgba(151,187,205,0.2)",
                                                strokeColor: "rgba(151,187,205,0.3)",
                                                highlightFill: "rgba(151,187,205,0.4)",
                                                highlightStroke: "rgba(151,187,205,0)",
                                                data: [randomnb(), randomnb(), randomnb(), randomnb(), randomnb(), randomnb(), randomnb(), randomnb(), randomnb(), 0, 0, 0]
